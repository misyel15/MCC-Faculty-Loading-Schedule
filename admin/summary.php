...
<div class="container-fluid">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<button type="button" class="btn btn-success btn-block btn-sm col-sm-1 float-right" id="print"><span class="glyphicon glyphicon-print"></span><i class="fas fa-print"></i> Print</button>
